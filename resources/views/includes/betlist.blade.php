<div class="flex flex-col">
    ...
    <div class="allBetList overflow-x-auto"></div>
    {{-- <div class="tab-pane fade show active" id="allBetList" role="tabpanel">
    
    </div>
    <div class="tab-pane fade" id="fancyBetList" role="tabpanel">
